...
function App() {
  ...
  async function startLaunch() {
    ...
    try {
      ...
      // Minimal proxy bytecode (EIP-1167) wrapping tokenImpl
      ...
      const predictAddress = (salt) => {
        ...
        return "0x" + hash.slice(-40); // last 20 bytes = address
      };

      let salt;
      let attempts = 0;
      // Generate random salt, hash repeatedly until address ends in 8888
      ...
      const params = {
        ...
        symbol:              form.ticker,
        meta:                ipfsCid,
        dexThresh:           3,        // FOUR_FIFTHS = 3 (80% threshold)
        salt:                salt,
        taxRate:             0,        // standard token, no tax
        migratorType:        1,        // V3_MIGRATOR = 1
        quoteToken:          "0x0000000000000000000000000000000000000000",
        quoteAmt:            0,
        beneficiary:         wallet,   // owner gets rev share after DEX graduation
        permitData:          "0x",
